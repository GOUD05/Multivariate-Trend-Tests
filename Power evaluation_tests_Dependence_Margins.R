...
Power_tests_Dependence_Margins = function(run_num,
                              copula,
                              coefs,
                              Nsim=1000,
                              Nbs=1000,
                             ...
                             )
{
  ...
  for (i in 1:Nsim) {
    ...
    for (j in 1:m) {
      ...
      margin_1[j] = qgev(rCop[1],location = location_param_x*j,scale = 1,shape = -0.1)
      margin_2[j] = qgev(rCop[2],location = location_param_y*j,scale = 1,shape = -0.1)
    }
